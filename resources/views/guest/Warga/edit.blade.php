        ...
        <div class="row mb-40">
            <div class="col-lg-12">
                <div class="section-title text-center">
                    <h3 class="mb-15 wow fadeInUp" data-wow-delay=".2s">Edit Data Warga</h3>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="single-input">
                                    ...
                                    <input type="text" id="no_ktp" name="no_ktp" class="form-input @error('no_ktp') is-invalid @enderror" 
                                           placeholder="Masukkan No. KTP (16 digit)" value="{{ old('no_ktp', $warga->no_ktp) }}" maxlength="16">
                            ...
                            <div class="col-md-6">
                                <div class="single-input">
                                    ...
                                    <input type="text" id="agama" name="agama" class="form-input @error('agama') is-invalid @enderror" 
                                           placeholder="Masukkan Agama" value="{{ old('agama', $warga->agama) }}">
                            ...
                            <div class="col-md-6">
                                <div class="single-input">
                                    ...
                                    <input type="text" id="pekerjaan" name="pekerjaan" class="form-input @error('pekerjaan') is-invalid @enderror" 
                                           placeholder="Masukkan Pekerjaan" value="{{ old('pekerjaan', $warga->pekerjaan) }}">
                            ...
                            <div class="col-md-6">
                                <div class="single-input">
                                    ...
                                    <input type="text" id="telepon" name="telepon" class="form-input @error('telepon') is-invalid @enderror" 
                                           placeholder="Masukkan No. Telepon" value="{{ old('telepon', $warga->telepon) }}" maxlength="15">
                            ...
                            <div class="col-md-12">
                                <div class="single-input">
                                    ...
                                    <input type="email" id="email" name="email" class="form-input @error('email') is-invalid @enderror" 
                                           placeholder="Masukkan Email" value="{{ old('email', $warga->email) }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-button">
                                    <button type="submit" class="button radius-10">Update <i class="lni lni-checkmark"></i></button>
